  ...
  return (
    <div className="container mx-auto py-10">
      ...
      <p className="text-lg mb-6">
        Welcome to Bike Store. By using our website and services, you agree to comply with the
      ...
      <p className="mb-4">
        As a user, you agree to provide accurate information, use our services in a legal manner,
        and follow all applicable laws.
      </p>

      <h2 className="text-2xl font-semibold mb-2">Account Security</h2>
      <p className="mb-4">
        You are responsible for maintaining the confidentiality of your account information. Notify
        us immediately if you believe there is unauthorized access to your account.
      </p>

  ...
  return (
    <div className="min-h-[400px] flex items-center justify-center">
      <div className="rounded-xl p-4 shadow-lg w-full max-w-md  border border-white/30">
        ...
        <p className="text-lg  mb-2">Your order is pending. Confirm your order details below:</p>
        ...
        <fetcher.Form method="post" className="mt-4 text-center">
          ...
          <button className="btn btn-active btn-success" type="submit" disabled={isSubmitting}>

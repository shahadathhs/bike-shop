...
export default function About() {
  return (
    <main className="pt-16 pb-4 container mx-auto">
      <h1 className="text-primary text-4xl font-bold mb-4 text-center">Know About Us</h1>
      ...
      <section className="mb-6">
        ...
        <p className="mt-2 text-gray-400">
          ...
          for our commitment to quality and customer satisfaction. Our team consists of experienced
          engineers, designers, and cycling enthusiasts who work tirelessly to create innovative and
          durable bikes for every kind of rider.
        </p>
      </section>

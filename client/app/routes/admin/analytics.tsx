    ...
    const fetchAnalytics = async () => {
      ...
      try {
        const response = await fetch(
          `${import.meta.env.VITE_API_URL}/orders/admin/analytics`,
          {
            headers: {
          ...
          <div className="shadow rounded-lg p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <div className="p-4 rounded-box border border-base-content/5 bg-base-100">
                ...
                <p className="text-2xl font-semibold">
                  {analytics.revenueSummary.totalOrders}
                </p>
              </div>
              <div className="p-4 rounded-box border border-base-content/5 bg-base-100">
            ...
            <div className="shadow-lg rounded-lg p-6">
              ...
              <div className="overflow-x-auto rounded-box border border-base-content/5 bg-base-100">
                <table className="w-full table table-zebra">
                  ...
                  <tbody>
                    {Object.entries(
                      analytics.orderAnalytics.ordersByStatus
                    ).map(([status, count]) => (
                      <tr key={status}>
                        <td>{status}</td>
                        <td>{count}</td>
            ...
            <div className="shadow-lg rounded-lg p-6">
              ...
              <div className="overflow-x-auto rounded-box border border-base-content/5 bg-base-100">
                <table className="w-full table table-zebra">
                  ...
                  <tbody>
                    {Object.entries(analytics.orderAnalytics.ordersByDate).map(
                      ([date, count]) => (
                        <tr key={date}>
                          <td>{date}</td>
                          <td>{count}</td>
